...
const ALIASES: Record<string, string> = {
  ...
  tibc: 'tibc',
  'capacite totale': 'tibc',
  troponin: 'troponin',
  troponine: 'troponin',
  homocysteine: 'homocysteine',
  microalbumin: 'microalbumin',
  microalbuminurie: 'microalbumin',
  cea: 'cea',
  afp: 'afp',
  ca125: 'ca125',
  'ca 125': 'ca125',
  ...
  ca153: 'ca153',
  'ca 15 3': 'ca153',
  'facteur rhumatoide': 'rheumatoid_factor',
  rheumatoid: 'rheumatoid_factor',
  zinc: 'zinc',
  'bilirubine indirecte': 'bilirubin_indirect',
  ინსულინი: 'insulin',
  კორტიზოლი: 'cortisol',
  ტესტოსტერონი: 'testosterone',
  ესტრადიოლი: 'estradiol',
  პროლაქტინი: 'prolactin',
  პროგესტერონი: 'progesterone',
  ამილაზა: 'amylase',
  ფიბრინოგენი: 'fibrinogen',
  ტრანსფერინი: 'transferrin',
  ტროპონინი: 'troponin',
  ჰომოცისტეინი: 'homocysteine',
  თუთია: 'zinc',
};
