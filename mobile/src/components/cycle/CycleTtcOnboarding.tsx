...
export function CycleTtcOnboarding({ visible, onClose, onConfirm }: Props) {
      ...
      <View style={{ flex: 1, justifyContent: 'flex-end' }}>
        ...
        >
          <ScrollView showsVerticalScrollIndicator={false}>
            ...
            >
              {ka.cycle.ttcOnboardTitle}
            </Text>
            <Text style={{ color: c.muted, fontSize: 14, lineHeight: 22, marginTop: 12 }}>
              {ka.cycle.ttcOnboardWhat}
            </Text>
            <Text style={{ color: c.muted, fontSize: 14, lineHeight: 22, marginTop: 10 }}>
              {ka.cycle.ttcOnboardHonesty}
            </Text>
            <Text style={{ color: c.muted, fontSize: 14, lineHeight: 22, marginTop: 10 }}>
              {ka.cycle.ttcOnboardPrivacy}
            </Text>
          </ScrollView>
          <Pressable
            onPress={onConfirm}
            accessibilityRole="button"
            accessibilityLabel={ka.cycle.ttcOnboardDone}
            style={{
              minHeight: 48,
              borderRadius: 16,
