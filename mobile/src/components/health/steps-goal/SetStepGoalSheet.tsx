      ...
      <Pressable style={{ flex: 1, backgroundColor: 'rgba(15,23,42,0.35)', justifyContent: 'flex-end' }} onPress={onClose}>
        ...
        >
          <View style={{ alignItems: 'center', paddingTop: 5, height: 16 }}>
            <View style={{ width: 36, height: 5, borderRadius: 100, backgroundColor: '#E5E7EB' }} />
          </View>
          ...
          <View style={{ padding: 16, gap: 20 }}>
            <View style={{ gap: 24, width: '100%' }}>
              <View style={{ gap: 16, alignItems: 'center' }}>
                ...
                >
                  <Pressable accessibilityRole="button" onPress={() => setDraft((n) => clampGoalSteps(n - STEPS_GOAL_SHEET_STEP))}>
              ...
              <View style={{ flexDirection: 'row', gap: 12 }}>
                {STEPS_GOAL_PRESETS.map((preset) => (
                  <Pressable
                    ...
                    style={{
                      flex: 1,
                      backgroundColor: draft === preset ? FIGMA_STEPS.brandQuaternary : FIGMA_STEPS.cardBg,
                      borderWidth: 1,
                      borderColor: draft === preset ? FIGMA_STEPS.brand : '#D1D5DB',
                      borderRadius: 12,
                  ...
                  <Text
                    style={{
                      ...
                      fontSize: 14,
                      lineHeight: 20,
                      color: draft === preset ? FIGMA_STEPS.brand : FIGMA_STEPS.textPrimary,
                    }}
                  >
                    {preset}
                  </Text>
