...
export function DiscoveryArtwork({tone='surface',height=172}:{tone?:'surface'|'spotlight';height?:number}){
 const c=useThemeColors(),s=tone==='spotlight';
 const river=s?'rgba(94,234,212,0.10)':c.accent100,block=s?'rgba(255,255,255,0.06)':c.bg200,edge=s?'rgba(255,255,255,0.08)':c.bg300,dash=s?'rgba(255,255,255,0.22)':c.bg300,ring=s?'#102C35':c.surface,trees=s?'rgba(94,234,212,0.16)':c.accent100,treeEdge=s?'rgba(94,234,212,0.28)':c.accent200,spark=s?'#99F6E4':c.primary100;
 return <Svg width="100%" height={height} viewBox="0 0 340 172" preserveAspectRatio="xMidYMid slice" accessible={false}>
  <Path d="M270 -20 C211 18 277 48 220 97 S221 169 157 193" stroke={river} strokeWidth="29" fill="none"/>
  <G fill={block} stroke={edge} strokeWidth=".7">
  ...
  <Path d="M-12 110 H111 Q139 110 139 85 V71 Q139 51 159 51 H250 Q270 51 270 30 V-10" fill="none" stroke={dash} strokeWidth="2" strokeDasharray="3 7" strokeLinecap="round"/>
  <Path d="M-12 110 H111 Q139 110 139 85 V71 Q139 51 159 51 H207" fill="none" stroke="#14B8A6" strokeWidth="14" strokeOpacity={s?.22:.12} strokeLinecap="round"/>
  <Path d="M-12 110 H111 Q139 110 139 85 V71 Q139 51 159 51 H207" fill="none" stroke={s?'#2DD4BF':'#14B8A6'} strokeWidth="5" strokeLinecap="round"/>
  <Circle cx="72" cy="110" r="5" fill={ring} stroke="#14B8A6" strokeWidth="2"/>
  <Circle cx="207" cy="51" r="25" fill="#14B8A6" fillOpacity={s?.16:.09}/><Circle cx="207" cy="51" r="17" fill="#14B8A6" fillOpacity={s?.2:.12}/>
  <Circle cx="207" cy="51" r="11" fill="#0D9488" stroke={ring} strokeWidth="3"/>
  <Path d="M211 42 L215 56 L203 51Z" fill="#CCFBF1"/>
  <G fill={trees} stroke={treeEdge} strokeWidth=".8"><Circle cx="245" cy="146" r="7"/><Circle cx="237" cy="127" r="6"/><Circle cx="321" cy="113" r="5"/></G>
  <G transform="translate(281 18)" fill="none" stroke={spark} strokeWidth="1.5" strokeLinecap="round"><Path d="M7 0 V14 M0 7 H14"/></G>
 </Svg>;
}
