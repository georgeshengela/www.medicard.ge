...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        sans: ['NotoSansGeorgian_400Regular'],
        'sans-medium': ['NotoSansGeorgian_500Medium'],
        'sans-semibold': ['NotoSansGeorgian_600SemiBold'],
        'sans-bold': ['NotoSansGeorgian_700Bold'],
        brand: ['MediFont'],
        'brand-bold': ['MediFontBold'],
      },
    },
  },
  plugins: [],
