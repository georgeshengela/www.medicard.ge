...
import { ChevronDown, EllipsisVertical, Search } from 'lucide-react-native';
    ...
    <View style={{ flex: 1, backgroundColor: T.canvas, paddingBottom: insets.bottom }}>
      <SymptomNavHeader
        ...
        right={
          ...
          >
            <EllipsisVertical size={22} color={T.textPrimary} strokeWidth={2} />
          </Pressable>
        }
      />
      <View
