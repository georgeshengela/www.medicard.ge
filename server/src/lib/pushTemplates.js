...
export const PUSH_TEMPLATE_DEFAULTS = [
  ...
  },
  {
    ...
    group: 'cycle',
    label: '📅 დაგეგმილი პრენატალური მოვლის შეხსენება',
    title: 'შეხსენება',
    body: 'შეგახსენებ: შენ დაგეგმე {item} {when}.',
    placeholders: ['item', 'when'],
    sample: { item: 'ანატომიის ულტრაბგერა', when: 'ხვალ' },
  },
  {
    key: 'pet-care',
    group: 'pets',
    label: '🐾 ცხოველის მოვლის შეხსენება',
    title: '{pet} · {item}',
    body: 'დაგეგმილი მოვლის დღეა. გახსენი და დაადასტურე.',
    placeholders: ['pet', 'item'],
    sample: { pet: 'ნუკრი', item: 'ტაბლეტი' },
  },
  {
    key: 'pet-care-masked',
    group: 'pets',
    label: '🔒 ცხოველის მოვლის დისკრეტული შეხსენება',
    title: 'Medi-სგან შეხსენება',
  ...
  {
    key: 'pregnancy-care-masked',
    group: 'cycle',
    label: '🔒 დაგეგმილი მოვლის დისკრეტული შეხსენება',
    title: 'Medi-სგან შეხსენება',
    body: 'შენი დაგეგმილი მოვლის შეხსენება',
    placeholders: [],
    sample: {},
