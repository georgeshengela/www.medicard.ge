...
import { eligible, publicContent, cleanImage, postInput, commentInput, notificationText } from './community.js';
...
test('anonymous serialization cannot leak identities, aliases, email, original photos or health data',()=>{
 ...
 assert.equal(dto.author,'ანონიმური წევრი');assert.equal(dto.mine,false);
});
