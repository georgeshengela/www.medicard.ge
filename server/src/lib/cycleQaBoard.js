...
export const PHASE_CATALOG = [
  ...
  C('medi-world-phase45', 'medi', 45, '1.0.0.7.82', 'PARTIAL', 'Friends / Trusted Circles',
    'ზუსტი friend code, Care Wave, Trusted Circle. ჯანმრთელობა და მდებარეობა არ იზიარება. Production default off.',
    { contract: 'docs/MEDI_WORLD_PHASE45_CONTRACT.md', sort: 145 }),
