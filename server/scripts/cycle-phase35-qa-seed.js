/**
 * Cycle Phase 35 — optional plannedTime QA seed.
 *
 *   node scripts/cycle-phase35-qa-seed.js none|timed
 *
 * Account: cycle.qa.phase6@medicard.ge / CycleQaPhase6a
 *
 * none  = future plannedDate, no plannedTime
 * timed = future plannedDate + 14:30
 */
...
async function main() {
  ...
  await prisma.pregnancyCarePlanItemState.create({
    data: {
      ...
      status: 'PLANNED',
      plannedDate,
      plannedTime: FIXTURE === 'timed' ? '14:30' : null,
