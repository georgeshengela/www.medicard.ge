...
try {
 ...
 if(statements.some(s=>!/^CREATE (TABLE|INDEX|UNIQUE INDEX) IF NOT EXISTS "Community|^ALTER TABLE "Community(?:Member|Notification|Post|Comment|Reaction)" ADD COLUMN IF NOT EXISTS/.test(s)))throw Error('Unexpected non-additive statement');
