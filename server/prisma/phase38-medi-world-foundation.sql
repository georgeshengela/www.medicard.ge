-- Medi World Phase 38 foundation — additive only.
-- Canonical apply (this repository):
--   npx prisma db execute --file prisma/phase38-medi-world-foundation.sql --schema prisma/schema.prisma
-- Environments that already track Prisma Migrate may instead run
--   prisma migrate deploy
-- which applies prisma/migrations/20260912120000_medi_world_foundation/ once.
-- Do not run both against the same database. Do NOT use prisma db push.
