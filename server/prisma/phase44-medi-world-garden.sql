...
--   (folder: prisma/migrations/20260913020000_medi_world_garden/)
-- Ordered after 20260913010000_medi_world_movement (Phase 43).
-- Do not run against production from this working tree.
-- Do NOT use prisma db push.
-- No historical plants or nurture backfill.
