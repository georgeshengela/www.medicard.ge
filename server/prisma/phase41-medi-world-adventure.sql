-- Medi World Phase 41 Daily Adventure — additive only.
-- Canonical apply (databases without `_prisma_migrations`, including this repo's historical path):
...
--   (folder: prisma/migrations/20260912220000_medi_world_adventure/)
-- Do not run against production from this working tree.
-- Do NOT use prisma db push.
-- Requires Phase 38/39 World tables and Phase 40 Companion tables at runtime.
-- Schema FKs are User + Adventure tables only; Phase 40 is a product predecessor, not a table FK.
